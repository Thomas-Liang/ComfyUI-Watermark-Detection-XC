...
class WatermarkDetector:
    ...
    RETURN_TYPES = ("IMAGE", "MASK","BBOXES","CLASSES","CONFIDENCES","RESULT","DETECT_RESULT")
    RETURN_NAMES = ("image", "mask","bboxes","classes", "confidences","result","detect_result")
    FUNCTION = "detect"
    CATEGORY = "watermark_detection"
    ...
    def detect(self, image, model, threshold=0.5):
        ...
        detect_result = "Watermarked" if confidences.any() else "Not Watermarked"
        return (result_tensor, mask_tensor, bboxes, classes, confidences,result,detect_result)
